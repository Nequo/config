...
if &background ==# 'dark'
  ...
  exe "hi! TSType guifg=". s:orange . " guibg=NONE gui=NONE cterm=NONE"
  ...
  exe "hi! LineNr guifg=". s:dimBackground3 . " guibg=NONE gui=NONE cterm=NONE"
  exe "hi! CursorLineNr guifg=". s:gray . " guibg=NONE gui=NONE cterm=NONE"
  exe "hi! CursorLine guifg=NONE guibg=". s:dimBackground2 . " gui=NONE cterm=NONE"
  exe "hi! Folded guifg=" . s:grayer . " guibg=" . s:folded . " gui=NONE cterm=NONE"
  exe "hi! VertSplit guifg=" . s:dimBackground3 . " guibg=" . s:dimBackground . " gui=NONE cterm=NONE"
  exe "hi! NonText guifg=" . s:dimBackground3 . " guibg=" . s:dimBackground . " gui=NONE cterm=NONE"
  exe "hi! Title guifg=" . s:blue . " guibg=" . s:dimBackground . " gui=NONE cterm=NONE"
  exe "hi! Search guifg=NONE guibg=" . s:yellow . " gui=NONE cterm=NONE"
  exe "hi! IncSearch guifg=". s:dimBackground . " guibg=" . s:brightyellow . " gui=NONE cterm=NONE"
  ...
  exe "hi! Visual guifg=NONE guibg=" . s:dimBackground3 . " gui=NONE cterm=NONE"
  ...
  " nvim-tree
  exe "hi! NvimTreeRootFolder guifg=" . s:cyan . " guibg=NONE gui=NONE cterm=NONE"
  ...
  exe "hi! TSNumber guifg="      . s:orange . " guibg=NONE gui=NONE cterm=NONE"
  exe "hi! TSKeyword guifg="      . s:red . " guibg=NONE gui=NONE cterm=NONE"
  exe "hi! TSInclude guifg="      . s:red . " guibg=NONE gui=NONE cterm=NONE"
