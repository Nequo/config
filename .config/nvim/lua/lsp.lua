...
local sumneko_root_path = "/home/nequo/.config/nvim/lua-language-server"
local sumneko_binary = "/home/nequo/.config/nvim/lua-language-server/bin/Linux/lua-language-server"
